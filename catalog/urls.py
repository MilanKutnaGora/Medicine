...
from catalog.views import index, index_contacts, ProductListView, ProductDetailView, ProductCreateView, \
    ProductUpdateView, staff
...
urlpatterns = [
    ...
    path('staff/', cache_page(60)(staff),name='staff'),
